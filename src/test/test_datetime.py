...
class datetime_test(unittest.TestCase):
    ...
    # def get_weekend_test(self):

    # def get_weekday_test(self):

    # def get_future_test(self):
    
    # def get_empty_1900_test(self):

    # def get_empty_1970_test(self):

    # def get_min_test(self):

    # def get_max_test(self):

    # def get_barchart_test(self):

    # def get_frequent_test(self):

    # def construct_table(_testself):
